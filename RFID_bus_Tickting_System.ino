...
//51 02 03 03 CC AF 84 C5 A0 80 5B 8F 4A E8 EB 23 B3 F1 04 FE 52 36 B3 1B 71 83 6B 80 88 FA A9 AB
...
String data2;
const String data1 = "https://script.google.com/macros/s/AKfycbw1iu7gaMEDlvj8NnXVQ_jr4uMueHgvc4KyJLHOunhlUCon5hh1d9PCIYrlZLZ7p6mn/exec?regno=";
...
void setup() 
{
  ...
  WiFiMulti.addAP("Galaxy M3194A6", "jkvh3990");
